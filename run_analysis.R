...
features <- read.table("UCI HAR Dataset/features.txt", col.names = c("#","feature"))
...
TidyData <- Merge_data %>% select(subject, num, contains("mean"), contains("std"))

# Appropriately labels the data set with descriptive variable names
TidyData$num <- activities[TidyData$num, 2]
